...
async def test_get_nodes_by_technology_id_not_found(bioimage_index):
    ...
    with pytest.raises(ValueError, match="Entity not found"):
        get_related_entities(bioimage_index, entity_id="nonexistent-tech-id")
...
async def test_get_technologies_by_node_id_not_found(bioimage_index):
    ...
    with pytest.raises(ValueError, match="Entity not found"):
        get_related_entities(bioimage_index, entity_id="nonexistent-node-id")
...
async def test_get_node_details(bioimage_index):
    ...
    with pytest.raises(ValueError, match="Entity not found"):
        await get_entity_details(bioimage_index, entity_id="nonexistent-node-id")
...
async def test_get_technology_details(bioimage_index):
    ...
    with pytest.raises(ValueError, match="Entity not found"):
        await get_entity_details(bioimage_index, entity_id="nonexistent-tech-id")
...
@pytest.mark.asyncio
async def test_mem0_bioimage_integration(mem0_bioimage_live_service):
